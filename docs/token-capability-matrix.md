...
| Exec / SSH into a service (`exec`) | ✅ (personal key) | ✅ (workspace key) | ❌ guard: fail-fast — keys are user/workspace-scoped, never a project | `sshPublicKeyCreate` probe (design `2026-07-09-railctl-exec-port-forward.md`) |
